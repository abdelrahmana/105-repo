...
class JobTitleSpinnerAdapter(
    ...
    private var mItems: ArrayList<JobTitleModel.Data>
)//        mTypeface=typeface;
    : ArrayAdapter<JobTitleModel.Data>(context, R.layout.spinner_text_item_small, mItems) {
